...
- MPLAB® Code Configurator (MCC) Plugin Version **5.6.2** (https://www.microchip.com/mcc)
- MPLAB® Code Configurator (MCC) Core Version **5.8.2** (https://www.microchip.com/mcc)
