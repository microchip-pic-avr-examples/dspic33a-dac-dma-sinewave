...
- MPLAB® XC-DSC Compiler Version **3.21** (https://www.microchip.com/xcdsc) 
- MPLAB® Code Configurator (MCC) Plugin Version **5.5.2** (https://www.microchip.com/mcc)
- MPLAB® Code Configurator (MCC) Core Version **5.7.1** (https://www.microchip.com/mcc)
- MPLAB® Code Configurator (MCC) Melody Core Version **2.9.1** (https://www.microchip.com/melody)
- PIC32/dsPIC devices Version **5.13.1** 
- dsPIC33AK-MC-DFP Version **1.2.125** 
